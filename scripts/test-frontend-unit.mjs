...
test("frontend helpers escape and render forecast badges", () => {
  assert.match(getForecastBadgeHtml(0.85, "Great"), /badge-great/);
  assert.match(getForecastBadgeHtml(0.45, "Fair"), /badge-fair/);
  assert.match(getForecastBadgeHtml(0.1, "Low"), /badge-muted/);
