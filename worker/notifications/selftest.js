...
import { getApplicationSettings } from "./application-settings.js";
...
import { hasWebPushConfiguredAsync, resolveWebPushConfig } from "./webpush.js";
...
export async function runActiveSelfTest(env, deps = {}) {
  ...
  const dispatch = deps.dispatchPendingNotifications
    || (await import("./dispatcher.js")).dispatchPendingNotifications;
