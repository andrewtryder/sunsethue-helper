...
## 2024-10-27 - ARIA Combobox for Autocomplete Inputs
**Learning:** Address search and autocomplete dropdowns are inherently inaccessible to screen reader users because dynamic DOM updates for suggestions go unnoticed. Additionally, users need feedback when the suggestion list opens/closes and need to know which item is currently highlighted during keyboard navigation.
