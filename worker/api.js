...
import { bodyErrorResponse } from "./routes/_shared.js";
import { tryHandle as tryApplicationSettings } from "./routes/application-settings.js";
import { tryHandle as tryNotificationRules } from "./routes/notification-rules.js";
import { tryHandle as tryWebPush } from "./routes/webpush.js";
import { tryHandle as tryWebhook } from "./routes/webhook.js";
import { tryHandle as tryNotificationHealth } from "./routes/notification-health.js";
import { tryHandle as trySetupStatus } from "./routes/setup-status.js";
import { tryHandle as tryHistory } from "./routes/history.js";
...
const ROUTE_HANDLERS = [
  tryApplicationSettings,
  tryNotificationRules,
  tryWebPush,
  tryWebhook,
  tryNotificationHealth,
  trySetupStatus,
  tryHistory
];
...
export async function handleHttpRequest(request, env, authContext = null, deps = {}) {
  ...
  try {
    const routeCtx = { request, env, authContext, deps, requestId, path, url };
